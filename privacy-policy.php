...
<div style="margin:12px 15px">
    ...
    <br/>
    Communicate with you about your purchase or account
    <br/>
    ...
    <br/>
    Service providers (like payment processors and shipping companies) who help fulfill your orders
    <br/>
    Law enforcement or regulators when required by law
    <br/>
    Analytics providers to help us understand usage trends (like Google Analytics)
    <br/>
    These partners are required to keep your data secure and use it only for the purpose we agreed upon.
    ...
    We use cookies to:
    <br/>
    Keep your cart items saved
    <br/>
    Understand how visitors use the site
    <br/>
    Customize your experience
    <br/>
    You can adjust your browser settings to disable cookies, but this may affect site functionality.
    
    <h2>6. Data Security</h2>
    We use encryption, firewalls, and secure payment gateways to keep your data safe. However, no system is 100% foolproof, so please keep your login information confidential.
